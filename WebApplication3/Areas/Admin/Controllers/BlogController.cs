        ...
        public IActionResult ExportStaticExcelBlogList()
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    return File(context, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Statik Dosya.xlsx");
                }
        ...
        public IActionResult ExportDinamikExcelBlogList()
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    workbook.SaveAs(stream);
                    var context = stream.ToArray();
                    return File(context, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Dinamik Dosya.xlsx");
                }
